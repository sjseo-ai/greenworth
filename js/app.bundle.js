(() => {
  ...
  var REQUIRED_MODEL_SECTIONS = Object.freeze(["project", "revenue", "capex", "opex", "finance", "assumptions"]);
  function importModel(payload) {
    ...
    const hasAllSections = model && typeof model === "object" && REQUIRED_MODEL_SECTIONS.every((key) => model[key] && typeof model[key] === "object");
    if (!hasAllSections) {
